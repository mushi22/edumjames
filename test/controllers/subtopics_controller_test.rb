...
class SubtopicsControllerTest < ActionController::TestCase
  ...
  test "should create subtopic" do
    assert_difference('Subtopic.count') do
      post :create, subtopic: { description: @subtopic.description, example: @subtopic.example, name: @subtopic.name, proof: @subtopic.proof, video_link: @subtopic.video_link }
    end
  ...
  test "should update subtopic" do
    patch :update, id: @subtopic, subtopic: { description: @subtopic.description, example: @subtopic.example, name: @subtopic.name, proof: @subtopic.proof, video_link: @subtopic.video_link }
    assert_redirected_to subtopic_path(assigns(:subtopic))
  end
