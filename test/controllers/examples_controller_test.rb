...
class ExamplesControllerTest < ActionController::TestCase
  ...
  test "should create example" do
    assert_difference('Example.count') do
      post :create, example: { content: @example.content, name: @example.name, video_link: @example.video_link }
    end
  ...
  test "should update example" do
    patch :update, id: @example, example: { content: @example.content, name: @example.name, video_link: @example.video_link }
    assert_redirected_to example_path(assigns(:example))
  end
